...
import "../styles/VGM.scss"; // Import custom SCSS
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="panel">
          ...
          <div className="form-grid">
            ...
            {/* Terminal Code (Manual Datalist implementation for Autocomplete) */}
            <div className="form-group">
              ...
              <datalist id="terminals">
                {getTerminalCodesByPort(formik.values.locId).map((t) => (
                ...
                {!hasShipperAuth && (
                  <>
                    ...
                    <SelectField
                      ...
                      required
                    />
                    <InputField label="Reg Number" name="shipRegNo" required />
                  </>
                )}
              </>
            )}
        ...
        <div className="panel">
          ...
          {formik.values.vgmEvalMethod === "M2" && (
            <div className="panel mt-4" style={{ backgroundColor: "#f1f5f9" }}>
        ...
        <div className="panel">
          <div className="d-flex gap-2 mb-4">
            <input
              ...
              onChange={formik.handleChange}
            />
            <label htmlFor="useEncryption">Use Encryption (Hash Key)</label>
          </div>
